...
class Graph:
    ...
    def print_graph(self):
        for i in range(self.V):
            # print("Adjacency list of vertex {} {} \n head".format(int(i/128)),format(i%128), end="")
...
print("In the image shown, Red path is DFS search, Green is BFS, Blue is Dijkstra, the greyish-blue are the points visited by random_search.")
